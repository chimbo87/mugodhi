...
function ChurchMembers() {
  ...
  const actionMenu = (
    <Menu>
      ...
      <Menu.Divider />
      <Menu.Item key="4" danger>Remove Member</Menu.Item>
    </Menu>
  );
  ...
  return (
    <Layout className="church-members-component">
      ...
      <Tabs defaultActiveKey="1" className="members-tabs">
        <TabPane tab={<span><TeamOutlined />Members List</span>} key="1">
        ...
        <TabPane tab={<span><HomeOutlined />Church Structure</span>} key="2">
